...
class License(Enum):
    cc_by_3 = "Attribution 3.0 United States"  # inactive
    cc_by_sa_3 = "Attribution-ShareAlike 3.0 United States"  # inactive
    cc_by_nc_3 = "Attribution-NonCommercial 3.0 United States"  # inactive
    cc_by_nd_3 = "Attribution-NoDerivs 3.0 United States"  # inactive
    cc_by_nc_nd_3 = "Attribution-NonCommercial-NoDerivs 3.0 United States"  # inactive
    cc_by_nc_sa_3 = "Attribution-NonCommercial-ShareAlike 3.0 United States"  # inactive
    rr_r = "All rights reserved"  # inactive
    cc_by_4 = "Creative Commons BY Attribution 4.0 International"
    cc_by_sa_4 = "Creative Commons BY-SA Attribution-ShareAlike 4.0 International"
    cc_by_nd_4 = "Creative Commons BY-ND Attribution-NoDerivatives 4.0 International"
    cc_by_nc_4 = "Creative Commons BY-NC Attribution-NonCommercial 4.0 International"
    cc_by_nc_nd_4 = (
        "Creative Commons BY-NC-ND Attribution-NonCommercial-NoDerivs 4.0 International"
    )
    cc_by_nc_sa_4 = "Creative Commons BY-NC-SA Attribution-NonCommercial-ShareAlike 4.0 International"
    cc_publicdomain_zero_1 = "Creative Commons CC0 1.0 Universal"
