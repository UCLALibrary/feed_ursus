...
# Defined as models in Californica
...
# https://github.com/UCLALibrary/californica/blob/main/config/authorities/resource_types.yml
ResourceType = Enum(
    "ResourceType",
    (
...
# https://github.com/UCLALibrary/californica/blob/main/config/authorities/rights_statements.yml
RightsStatement = Enum(
    "RightsStatement",
    (
        (
        ...
        ("http://vocabs.library.ucla.edu/rights/unknown", "unknown"),  # active: true
        (
...
# https://github.com/UCLALibrary/californica/blob/main/config/authorities/iiif_text_directions.yml
TextDirection = Enum(
    "TextDirection",
    [
...
# https://github.com/UCLALibrary/californica/blob/main/config/authorities/iiif_viewing_hints.yml
ViewingHint = Enum(
    "ViewingHint",
    (
...
# https://github.com/UCLALibrary/californica/blob/main/config/authorities/languages.yml
language_names = {
    "aar": "Afar",
    "abk": "Abkhaz",
    "ace": "Achinese",
    ...
    "hrv": "Croatian",
    "hsb": "Upper Sorbian",
    "hto": "Murui, Mɨnɨka dialect [Minica Huitoto]",
    "hun": "Hungarian",
    "hup": "Hupa",
    "huu": "Murui, Bue dialect [Murui Huitoto]",
    "iba": "Iban",
    "ibo": "Igbo",
    "ice": "Icelandic",
    "ido": "Ido",
...
def validate_language(lang: str) -> str:
    if lang not in language_names:
        raise ValueError(
            f"{lang} is not a valid UCLA language code (see https://github.com/UCLALibrary/californica/blob/main/config/authorities/languages.yml)"
        )
...
Language = Annotated[
    str,
    AfterValidator(validate_language),
]
