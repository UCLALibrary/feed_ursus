...
def map_record(record) -> typing.Dict[str, typing.Any]:
  ...
  new_record.update({map_field_name(key): map_field_value(key, value) 
  ...
  new_record['human_readable_resource_type_sim'].extend(new_record['resource_type_tesim'])
  new_record['location_sim'].extend(new_record['location_tesim'])
  new_record['member_of_collections_ssim'].extend(new_record['dlcs_collection_name_tesim'])
